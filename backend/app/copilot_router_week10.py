...
- If the user asks for a breakdown, guide them to choose an attribute (e.g., Country, Dimension, Supplier).
- Once the attribute is known, set "action": "breakdown" and return a friendly reply explaining what will be analyzed.
